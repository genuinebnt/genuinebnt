...
<!--
  Every image below is generated by .github/workflows/profile-cards.yml and
  committed into assets/. Nothing here calls a third-party service at page load,
  so no shared API quota can turn these into "Failed to retrieve contributions".
-->
...
<img height="220" src="assets/calendar.svg" alt="contribution calendar"/>
&nbsp;&nbsp;
<img height="220" src="assets/wakatime.svg" alt="coding time"/>
